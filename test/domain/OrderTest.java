...
public class OrderTest {
	...
	public void setUp() throws Exception {
		...
		order1 = new Order(mockSuperModel2, spectacles2, dt1, dt2);
	}
	...
	public void test_constructorInvalidSpecifications() {
		...
		Order test = new Order(mockSuperModel, spectacles, dt1, dt2);
	...
	public void test_constructorNullPointerExceptionModel() {
		...
		Order test = new Order(null, spectacles, dt1, dt2);
	}
	
	@Test
	public void test_constructorNullPointerExceptionSpecs() {
		exception.expect(NullPointerException.class);
		Order test = new Order(mockSuperModel, null, dt1, dt2);
	}

	@Test
	public void test_constructorNullPointerExceptionInitDateTime() {
		exception.expect(NullPointerException.class);
		Order test = new Order(mockSuperModel, spectacles, null, dt2);		
	}

	@Test
	public void test_constructorNullPointerExceptionCompletionDateTime() {
		exception.expect(NullPointerException.class);
		Order test = new Order(mockSuperModel, spectacles, dt1, null);		
	}
